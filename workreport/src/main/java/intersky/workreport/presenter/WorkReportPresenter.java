...
public class WorkReportPresenter implements Presenter {
	...
	public void initView() {
		...
		ToolBarHelper.setSutColor(mWorkReportActivity, Color.parseColor("#00ffffff"));
		mWorkReportActivity.setContentView(R.layout.activity_work_report);
		ImageView back = mWorkReportActivity.findViewById(R.id.back);
		back.setOnClickListener(mWorkReportActivity.mBackListener);
		mWorkReportActivity.title = mWorkReportActivity.findViewById(R.id.title);
		...
		mWorkReportActivity.title.setText("Hi,"+WorkReportManager.getInstance().oaUtils.mAccount.getName());
