...
public class ReportListPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ImageView back = mReportListActivity.findViewById(R.id.back);
        back.setOnClickListener(mReportListActivity.mBackListener);
        TextView title = mReportListActivity.findViewById(R.id.title);
        if (mReportListActivity.getIntent().getIntExtra("ntype", 0) == ReportListActivity.TYPE_RECEIVE)
            title.setText(mReportListActivity.getString(R.string.xml_workreport_my_receive));
        if (mReportListActivity.getIntent().getIntExtra("ntype", 0) == ReportListActivity.TYPE_COPY)
            title.setText(mReportListActivity.getString(R.string.xml_workreport_my_join));
        if (mReportListActivity.getIntent().getIntExtra("ntype", 0) == ReportListActivity.TYPE_SEND)
            title.setText(mReportListActivity.getString(R.string.xml_workreport_my_send));
...
//        mReportListActivity.delete = mReportListActivity.findViewById(R.id.delete);
    ...
    public void showLeft() {
        ...
        mReportListActivity.mRightTeb.setBackgroundResource(R.drawable.shape_bg_readbgun);
        mReportListActivity.mRightImg.setTextColor(Color.parseColor("#8F9093"));
        mReportListActivity.mMiddeleTeb.setBackgroundResource(R.drawable.shape_bg_readbgun);
        mReportListActivity.mMiddleImg.setTextColor(Color.parseColor("#8F9093"));
        mReportListActivity.mLefttTeb.setBackgroundResource(R.drawable.shape_bg_readbg);
        mReportListActivity.mLefttImg.setTextColor(Color.parseColor("#FFFFFF"));
    ...
    public void showMiddle() {
        ...
        mReportListActivity.mRightTeb.setBackgroundResource(R.drawable.shape_bg_readbgun);
        mReportListActivity.mRightImg.setTextColor(Color.parseColor("#8F9093"));
        mReportListActivity.mLefttTeb.setBackgroundResource(R.drawable.shape_bg_readbgun);
        mReportListActivity.mLefttImg.setTextColor(Color.parseColor("#8F9093"));
        mReportListActivity.mMiddeleTeb.setBackgroundResource(R.drawable.shape_bg_readbg);
        mReportListActivity.mMiddleImg.setTextColor(Color.parseColor("#FFFFFF"));
    ...
    public void showRight() {
        ...
        mReportListActivity.mLefttTeb.setBackgroundResource(R.drawable.shape_bg_readbgun);
        mReportListActivity.mLefttImg.setTextColor(Color.parseColor("#8F9093"));
        mReportListActivity.mRightTeb.setBackgroundResource(R.drawable.shape_bg_readbg);
        mReportListActivity.mRightImg.setTextColor(Color.parseColor("#FFFFFF"));
