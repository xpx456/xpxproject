    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (mReport.mType)
        {
            ...
            case WorkReportManager.TYPE_MONTH:
                ...
                String time = mReport.mBegainTime.substring(0,4)+"年"+ mReport.mBegainTime.substring(4,6)+"月份"+typename;
                mview.mtitle.setText(mReport.userName+" "+typename+"("+ mReport.mBegainTime.substring(0,7)+")");
                break;
        }
        mview.msubject.setText(mReport.mCreatTime.substring(5, mReport.mCreatTime.length()-3)+" "+mContext.getString(R.string.keyword_xingqi)+ TimeUtils.getWeek(mReport.mCreatTime.substring(0,10)));
        ...
        {
            mview.mSelectIcon.setVisibility(View.INVISIBLE);
        }
        return convertView;
    }
