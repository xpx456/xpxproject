...
public class NewReportActivity extends BaseActivity
{
	...
	public View.OnClickListener mDeletePicListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			mNewReportPresenter.removePic(v);
		}
	};
	...
	public View.OnClickListener mShowAddListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			mNewReportPresenter.showAdd( );
		}
	};

	@Override
	public boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent1, float v, float v1) {
		return mNewReportPresenter.onFling(motionEvent, motionEvent1, v, v1);
	}

	public boolean onKeyDown(int keyCode, KeyEvent event) {

		if (keyCode == KeyEvent.KEYCODE_BACK) {//如果触及到返回键所要执行的操作是什么
			mNewReportPresenter.chekcBack();
			return true;
		}
