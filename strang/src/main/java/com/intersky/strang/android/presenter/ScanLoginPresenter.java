...
import com.intersky.strang.android.handler.ScanLoginHandler;
...
//{"serial":"C7BDC05A-00C8-407B-8596-14F023561622","type":1}
    ...
    public void initView() {
        ...
        try {
            ...
            ToolBarHelper.setTitle(mScanLoginActivity.mActionBar,mScanLoginActivity.getString(R.string.safe_loing_title1));
        } catch (JSONException e) {
            e.printStackTrace();
            mScanLoginActivity.nomalLayer.setVisibility(View.GONE);
            mScanLoginActivity.txtError.setText(mScanLoginActivity.result);
            ToolBarHelper.setTitle(mScanLoginActivity.mActionBar,mScanLoginActivity.getString(R.string.safe_loing_title2));
        }
    }
