...
import com.intersky.strang.android.presenter.LoginPresenter;
...
public class LoginActivity extends BaseActivity {
    ...
    public TextWatcher accountChange = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            if(eTxtAccount.getText().toString().length() > 0 && StrangApplication.mApp.mService != null)
            {
            ...
            if(StrangApplication.mApp.mService == null)
            {
                ...
                {
                    btnLogin.setEnabled(true);
                    StrangApplication.mApp.mService = new Service();
                    StrangApplication.mApp.mService.https = false;
                    StrangApplication.mApp.mService.sType = true;
                    StrangApplication.mApp.mService.sAddress = "cloud.intersky.com.cn";
                    StrangApplication.mApp.mService.sPort = "80";
                }
            }
        }
