...
import com.intersky.strang.android.receiver.ServiceListReceiver;
...
import com.intersky.strang.android.view.adapter.ServerListAdapter;
...
//        });
        ...
        ToolBarHelper.setTitle(mServiceListActivity.mActionBar,mServiceListActivity.getString(R.string.activity_title_servicelist));
        ToolBarHelper.setRightBtnText(mServiceListActivity.mActionBar,mServiceListActivity.mAddNewServiceListener,mServiceListActivity.getString(R.string.servicelist_add));
    }
