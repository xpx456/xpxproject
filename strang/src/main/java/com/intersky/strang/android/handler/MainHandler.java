...
import com.intersky.strang.android.prase.OaMessagePrase;
        ...
        switch (msg.what) {
            ...
            case UPDATE_CONVERSATION:
                ...
                if(msg.arg1 == 1)
                {
                    ...
                    StrangApplication.mApp.chatUtils.addMessage(conversations);
                }
                else if(msg.arg1 == 2)
                {
                    intent = (Intent) msg.obj;
                ...
                {
                    intent = (Intent) msg.obj;
                    StrangApplication.mApp.chatUtils.updataMessage(intent.getParcelableExtra("msg"));
                }
                break;
            case GET_TASK_COUNT:
