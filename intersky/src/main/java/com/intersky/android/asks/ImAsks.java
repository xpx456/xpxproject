...
public class ImAsks {
    ...
    public static void getImMessage(Context mContext, Handler mHandler,int event) {
        try {
            String urlString = NetUtils.getInstance().praseUrl(InterskyApplication.mApp.mService,NOTATION_MESSAGE_IM);
    ...
    public static void uploadFile(Context mContext, Handler mHandler,int success, Conversation msg) {
        ...
        String urlString = NetUtils.getInstance().praseUrl(InterskyApplication.mApp.mService,MESSAGE_UPLOAD);
    ...
    public static void sendMsg(Context mContext, Handler mHandler,int success, Conversation msg,long time,int repeat) {
        try {
            String urlString = NetUtils.getInstance().praseUrl(InterskyApplication.mApp.mService,MESSAGE_SEND);
    ...
    public static String imFileDownloadUrl(String id) {
        ...
        String urlString = NetUtils.getInstance().praseUrl(InterskyApplication.mApp.mService,MESSAGE_DOWNLOAD);
