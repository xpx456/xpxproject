...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "resraurant.db";
    ...
    {
        for(Map.Entry<String,Guest> map : RestaurantApplication.mApp.guestHashMap.entrySet())
        {
