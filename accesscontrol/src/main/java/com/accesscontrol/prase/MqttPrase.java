...
public class MqttPrase {
    ...
    public static final String ACTION_ADD_MASTER = "ACTION_ADD_MASTER";
    public static final String ACTION_BUESY = "ACTION_BUESY";


    public static final String ACTION_RECEIVER_OFFER = "ACTION_RECEIVER_OFFER";
    ...
    public static String[] praseMy(String json) {
        ...
        try {
            ...
            if(cmd.equals(MqttAsks.ACTION_ACCEPT))
            {
                accept(json);
            ...
            else if(cmd.equals(MqttAsks.ACTION_OPEN))
            {
                open(json);
                jsonObject.put("success",true);
                jsonObject.put("msg","");
            ...
            else if(cmd.equals(MqttAsks.ACTION_REFOUS))
            {
                refous(json);
                jsonObject.put("success",true);
                jsonObject.put("msg","");
            ...
            else if(cmd.equals(MqttAsks.ACTION_EXIST))
            {
                exist(json);
                jsonObject.put("success",true);
                jsonObject.put("msg","");
            ...
            else if(cmd.equals(MqttAsks.ACTION_SHOWVIEW))
            {
                showViewSuccess(json);
                jsonObject.put("success",true);
                jsonObject.put("msg","");
                back[0] = "";
            }
            ...
            else if(cmd.equals(MqttAsks.SEND_OFFER))
            {
                receiverOffer(json);
                jsonObject.put("success",true);
                jsonObject.put("msg","");
            ...
            else if(cmd.equals(MqttAsks.LIVE))
            {
                askLive(json);
                jsonObject.put("success",true);
                jsonObject.put("msg","");
    ...
    public static String[] praseHome(String json) {
        String [] back = new String[2];
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            String cmd = jsonObject.getString("action");
            back[1] = jsonObject.getString("cid");
            if(cmd.equals(MqttAsks.ACTION_IMF))
            {
                jsonObject.put("success",true);
                jsonObject.put("msg","");
                back[0] = "";
            ...
            if(cmd.equals(MqttAsks.ACTION_SEND_MASTER))
            {
                jsonObject.put("success",true);
                jsonObject.put("msg","");
                back[0] = "";
    ...
    public static String praseAlwaysOpen(String json) {
        try {
            ...
            if(start.length() == 19 && end.length() == 19 && (code.equals("01") || code.equals("02")))
            {
                ...
                AccessControlApplication.mApp.sendBroadcast(intent);
            }
            else
            {
    ...
    public static String praseGuest(String json) {
        try {
            ...
            for (int i = 0 ; i < ja.length() ; i++)
            {
                ...
                guest1.fingerName = jo.getString("fingerName");
                fingers.add(guest1);
    ...
    public static String showViewSuccess(String json) {
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            jsonObject.put("success",true);
            jsonObject.put("msg","");
    ...
    public static String busey(String json) {
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            jsonObject.put("success",true);
            Intent intent = new Intent(ACTION_BUESY);
            intent.putExtra("mid",jsonObject.getString("mid"));
            intent.putExtra("hasconnect",jsonObject.getBoolean("hasconnect",true));
            AccessControlApplication.mApp.sendBroadcast(intent);
            return jsonObject.toString();
        } catch (JSONException e) {
            e.printStackTrace();
    ...
    public static String accept(String json)
    {
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            jsonObject.put("success",true);
            Intent intent = new Intent(ChatReceiver.ACITON_CONNECT_ACCEPT);
    ...
    public static String open(String json)
    {
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            jsonObject.put("success",true);
    ...
    public static String refous(String json)
    {
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            jsonObject.put("success",true);
            Intent intent = new Intent(ChatReceiver.ACITON_CONNECT_REFOUS);
            AccessControlApplication.mApp.sendBroadcast(intent);
            return jsonObject.toString();
        } catch (JSONException e) {
            e.printStackTrace();
    ...
    public static String exist(String json)
    {
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            jsonObject.put("success",true);
            Intent intent = new Intent(ChatReceiver.ACITON_CONNECT_EXIST);
            intent.putExtra("mid",jsonObject.getString("mid"));
            intent.putExtra("hasconnect",jsonObject.getBoolean("hasconnect",false));
            AccessControlApplication.mApp.sendBroadcast(intent);
            return jsonObject.toString();
        } catch (JSONException e) {
            e.printStackTrace();
    ...
    public static void addMaster(String json) {
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            jsonObject.put("success",true);
            Intent intent = new Intent(MqttPrase.ACTION_ADD_MASTER);
            intent.putExtra("cid",jsonObject.getString("cid"));
            intent.putExtra("cname",jsonObject.getString("cname"));
            AccessControlApplication.mApp.sendBroadcast(intent);
    ...
    public static void receiverOffer(String json)
    {
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            jsonObject.put("success",true);
            Intent intent = new Intent(MqttPrase.ACTION_RECEIVER_OFFER);
            intent.putExtra("mid",jsonObject.getString("mid"));
            intent.putExtra("cname",jsonObject.getString("cname"));
    ...
    public static String askLive(String json) {
        try {
            XpxJSONObject jsonObject = new XpxJSONObject(json);
            jsonObject.put("success",true);
    ...
    public static void doSendImf() {
        Intent intent = new Intent(MyMqttService.ACTION_SEND_MESSAGE);
        AccessControlApplication.mApp.sendBroadcast(intent);
    }
