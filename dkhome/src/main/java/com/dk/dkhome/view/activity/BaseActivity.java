...
import com.dk.dkhome.presenter.BasePresenter;
import com.dk.dkhome.utils.PermissionResult;
...
public class BaseActivity extends AppCompatActivity implements GestureDetector.OnGestureListener, View.OnTouchListener {
    ...
    public intersky.appbase.PermissionResult permissionRepuest;
    public ArrayList<PermissionResult> permissionRepuestList = new ArrayList<PermissionResult>();
    public String rid;
    ...
    protected void onStart() {
        ...
        if(this.findViewById(R.id.buttomaciton) != null)
            this.mToolBarHelper.hidToolbar(this, (RelativeLayout) this.findViewById(R.id.buttomaciton));
        if(this.findViewById(R.id.stutebar) != null)
            this.measureStatubar(this, (RelativeLayout) this.findViewById(R.id.stutebar));
