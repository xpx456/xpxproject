...
public class AnimManager {
    ...
    private void createImageAndAnim(final int[] startLocation, final int[] endLocation) {
        if(animModule == AnimModule.SMALL){
            ...
            Glide.with(getActivity()).load(imageUrl).into(new SimpleTarget<Drawable>() {
                @Override
                ...
                animImageView.setImageResource(src);
                setAnim(animImageView, startLocation, endLocation);
        }else {
            if (startView != null) {
                final ImageView circleImageView = new ImageView(getActivity());
                ...
                Glide.with(getActivity()).load(imageUrl).into(new SimpleTarget<Drawable>() {
                    ...
                    circleImageView.setImageResource(src);
                    setAnim(circleImageView, startLocation, endLocation);
            }
        }
    }

    public static void loadImageInbackGround(Context context, String url, View view, int defResId) {
