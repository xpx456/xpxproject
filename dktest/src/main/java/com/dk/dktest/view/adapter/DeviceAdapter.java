...
public class DeviceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(DkTestApplication.mApp.bluetoothSetManager.bluetoothDevice == null)
        {
        ...
        else
        {
            if(device.getBondState() == BluetoothDevice.BOND_BONDED &&
                    device.getAddress().equals(DkTestApplication.mApp.
                            bluetoothSetManager.bluetoothDevice.getAddress()) &&
                    DkTestApplication.mApp.bluetoothSetManager.mConnectionState == BluetoothSetManager.STATE_CONNECTED)
            {
    ...
    public View.OnClickListener connectListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if(DkTestApplication.mApp.bluetoothSetManager.bluetoothDevice == null)
            {
                DkTestApplication.mApp.bluetoothSetManager.autoConnectDevice(context,root,bluetoothDevice);
            }
            else
            {
                if(bluetoothDevice.getAddress().equals(DkTestApplication.mApp.bluetoothSetManager.bluetoothDevice.getAddress())
                && bluetoothDevice.getBondState() == BluetoothDevice.BOND_BONDED && DkTestApplication.mApp.bluetoothSetManager.mConnectionState == BluetoothSetManager.STATE_CONNECTED)
                {
                    DkTestApplication.mApp.bluetoothSetManager.disconnect();
                }
                else
                {
                    DkTestApplication.mApp.bluetoothSetManager.autoConnectDevice(context,root,bluetoothDevice);
