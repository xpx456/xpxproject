...
public class TestManager {
    ...
    public void startTest() {
        if(type == 2)
        {
            testManager.xpxUsbManager.sendData(xpxUsbManager.setLeave(test.currentLeavel));
            sendData();
        }
        else if(type == 1)
        {
            mWrite.setValue(xpxUsbManager.setLeave(test.currentLeavel));
    ...
    public void setLeavel(int leavel) {
        if(type == 2)
        {
            testManager.xpxUsbManager.sendData(xpxUsbManager.setLeave(leavel));
        }
        else if(type == 1)
        {
            mWrite.setValue(xpxUsbManager.setLeave(leavel));
            bluetoothSetManager.mBluetoothGatt.writeCharacteristic(mWrite);
        }
    ...
    public void addLeave() {
        if (test.currentLeavel < DkPadApplication.mApp.maxSelect) {
            test.currentLeavel++;
        }
