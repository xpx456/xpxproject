...
import com.dk.dkpad.entity.DecimalInputTextWatcher;
import com.dk.dkpad.entity.User;
import com.dk.dkpad.entity.UserWeight;
import com.dk.dkpad.handler.UserHandler;
...
public class UserPresenter implements Presenter {
    ...
    public View.OnClickListener setHeadListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            DkPadApplication.mApp.fileUtils.checkPermissionTakePhoto(mUserActivity,
                    DkPadApplication.mApp.fileUtils.pathUtils.getfilePath("head/photo"),
        ...
        switch (requestCode) {
            ...
            case MainActivity.TAKE_PHOTO_BG:
                if (resultCode == Activity.RESULT_OK) {
                    File file = new File(DkPadApplication.mApp.fileUtils.takePhotoPath);
                    String name = file.getName().substring(0, file.getName().lastIndexOf("."));
                    if (file.exists()) {
                        if (requestCode == MainActivity.TAKE_PHOTO_HEAD) {
                            // 开启裁剪,设置requestCode为CROP_PHOTO
                            DkPadApplication.mApp.fileUtils.cropPhoto(mUserActivity, 1, 1, file.getPath(),
                                    DkPadApplication.mApp.fileUtils.getOutputHeadMediaFileUri(
                                            DkPadApplication.mApp.fileUtils.pathUtils.getfilePath("head/photo"), name).getPath()
                            ...
                            // 开启裁剪,设置requestCode为CROP_PHOTO
                            DkPadApplication.mApp.fileUtils.cropPhoto(mUserActivity, 9, 5, file.getPath(), DkPadApplication.mApp.fileUtils.getOutputBgMediaFileUri(DkPadApplication.mApp.fileUtils.pathUtils.getfilePath("bg/photo"), name).getPath()
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (file.exists()) {
                        ...
                        if (requestCode == MainActivity.CHOSE_PICTURE_HEAD) {
                            // 开启裁剪,设置requestCode为CROP_PHOTO
                            DkPadApplication.mApp.fileUtils.cropPhoto(mUserActivity, 1, 1, path, DkPadApplication.mApp.fileUtils.getOutputHeadMediaFileUri(DkPadApplication.mApp.fileUtils.pathUtils.getfilePath("head/photo"), name).getPath()
                            ...
                            // 开启裁剪,设置requestCode为CROP_PHOTO
                            DkPadApplication.mApp.fileUtils.cropPhoto(mUserActivity, 9, 5, path, DkPadApplication.mApp.fileUtils.getOutputBgMediaFileUri(DkPadApplication.mApp.fileUtils.pathUtils.getfilePath("bg/photo"), name).getPath()
                                    , mUserActivity.mBasePresenter.mScreenDefine.ScreenWidth, (int) (200 * mUserActivity.mBasePresenter.mScreenDefine.density), MainActivity.CROP_BG);
            ...
            case MainActivity.CROP_HEAD:
                if (resultCode == Activity.RESULT_OK) {
                    ArrayList<String> paths = DkPadApplication.mApp.fileUtils.getImage(data);
