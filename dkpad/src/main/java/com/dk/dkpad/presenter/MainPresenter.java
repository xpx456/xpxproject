...
public class MainPresenter implements Presenter {
    ...
    public void initOptionSport() {
        ...
        mMainActivity.sportLegend.add("档位");
        ...
        yAxis.put("name", "档位");
        yAxis.put("max", String.valueOf(DkPadApplication.mApp.maxSelect));
        axisLine = new ObjectData();
        yAxis.put("axisLine", axisLine);
        lineStyle = new ObjectData();
        axisLine.put("lineStyle", lineStyle);
    ...
    public void updata(String[] data) {
        ...
        mMainActivity.selectvalue.setText(data[2]+"档");
    ...
    public void setLeave(int leave)
    {
        ...
        mMainActivity.selectvalue.setText(String.valueOf(leave)+"档");
    ...
    public void initOptionPerson() {
        ...
        jo2.put("max", String.valueOf(DkPadApplication.mApp.maxSelect));
