...
JNIEXPORT jobject JNICALL Java_android_1serialport_1api_SerialPort_open2(JNIEnv *env,jclass thiz,jstring path, jint baudrate,jint databits,jint stopbits,jchar parity)
{
