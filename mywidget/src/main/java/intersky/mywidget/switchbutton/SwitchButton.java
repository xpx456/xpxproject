package intersky.mywidget.switchbutton;
...
public class SwitchButton extends CompoundButton {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (useGeneralDisableEffect) {
			canvas.saveLayerAlpha(mSaveLayerZone, 255 / 2, MATRIX_SAVE_FLAG | CLIP_SAVE_FLAG | HAS_ALPHA_LAYER_SAVE_FLAG | FULL_COLOR_LAYER_SAVE_FLAG
