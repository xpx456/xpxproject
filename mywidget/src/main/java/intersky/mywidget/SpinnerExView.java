...
public class SpinnerExView extends LinearLayout {
    ...
    public SpinnerExView(final Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.include_my_spinnerviewex, this);
    ...
    public SpinnerExView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setMyData(ArrayList<String> data){
        ...
        mSpinnerImag.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                showWindow(v);
            }
