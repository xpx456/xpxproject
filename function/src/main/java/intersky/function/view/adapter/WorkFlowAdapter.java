...
public class WorkFlowAdapter extends BaseAdapter
{
	...
	public ArrayList<WorkFlowItem> mData;
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if( null == convertView )
		{
			...
			mViewHolder.caption = (ImageView) convertView.findViewById(R.id.caption);
			mViewHolder.caption.setImageResource(R.drawable.workflowitem);
		...
		mViewHolder.time.setText(TimeUtils.measureDeteForm(mContext,item.receiveTime));
