...
public class GridPresenter implements Presenter {
    ...
    public void initView() {
        ...
        TextView title = mGridActivity.findViewById(R.id.title);
        ImageView back = mGridActivity.findViewById(R.id.back1);
        back.setOnClickListener(mGridActivity.mBackListener);
        ...
        title.setText(mGridActivity.mFunction.mCaption);
        initPopupWindow2();
