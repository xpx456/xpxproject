...
public class GridDetialPresenter implements Presenter {
    ...
    public void initView() {
        ...
        title = mGridDetialActivity.findViewById(R.id.title);
        more = mGridDetialActivity.findViewById(R.id.more);
        more.setVisibility(View.INVISIBLE);
        back = mGridDetialActivity.findViewById(R.id.back1);
        back.setOnClickListener(mGridDetialActivity.mBackListener);
        ...
        title.setText(mGridDetialActivity.mFunction.mCaption);
        initPopupWindow2();
        ...
        if(mGridDetialActivity.getIntent().getBooleanExtra("edit",false) == false)
        {
            ...
            if (mGridDetialActivity.mTableDetial.attachmentData.length() > 0) {
                if (mGridDetialActivity.mFunction.canEdit == true) {
                    ...
                    more.setText(mGridDetialActivity.getString(R.string.menu_more));
                    more.setOnClickListener(mGridDetialActivity.mMoreListenter);
                } else {

                    more.setVisibility(View.VISIBLE);
                    more.setText(mGridDetialActivity.getString(R.string.menu_attchment));
                    more.setOnClickListener(mGridDetialActivity.showAttachmentListener);
                }
            } else {
                if (mGridDetialActivity.mFunction.canEdit == true) {
            ...
            more.setVisibility(View.VISIBLE);
            more.setText(mGridDetialActivity.getString(R.string.button_new));
            more.setOnClickListener(mGridDetialActivity.doCreatListener);
