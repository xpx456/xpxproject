...
public class TaskManagerActivity extends BaseActivity implements PullToRefreshView.OnHeaderRefreshListener, PullToRefreshView.OnFooterRefreshListener{
    ...
    public RelativeLayout lineTask;
    public RelativeLayout lineProject;
    ...
    public TaskAdapter mTaskSearchAdapter;
    public ClassAdapter mStatuAdapter;
    public ClassAdapter mPersonAdapter;
    public ClassAdapter mOrderAdapter;
    public TagClassAdapter mTagAdapter;
