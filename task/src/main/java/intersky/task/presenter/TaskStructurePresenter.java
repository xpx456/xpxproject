...
//        mTaskStructureActivity.addArea = (RelativeLayout) mTaskStructureActivity.findViewById(R.id.new_task);
        ...
        AppUtils.setContactCycleHead(mTaskStructureActivity.head,taskPerson.getName(),taskPerson.colorhead);
        mTaskStructureActivity.newTaskArea = (RelativeLayout) mTaskStructureActivity.findViewById(R.id.new_task);
        ToolBarHelper.setTitle(mTaskStructureActivity.mActionBar, mTaskStructureActivity.getString(R.string.task_structure_task_structure));
        ...
        {
            ToolBarHelper.setRightBtnText(mTaskStructureActivity.mActionBar, mTaskStructureActivity.doEditListtener, mTaskStructureActivity.getString(R.string.button_word_edit));
        }
        else
        {
    ...
    public void onEdit() {
        ...
        if (mTaskStructureActivity.mTask.isLocked == 0 || mTaskStructureActivity.mTask.leaderId.equals(TaskManager.getInstance().oaUtils.mAccount.mRecordId)
                || mTaskStructureActivity.mTask.userId.equals(TaskManager.getInstance().oaUtils.mAccount.mRecordId))
        {
            ToolBarHelper.setRightBtnText(mTaskStructureActivity.mActionBar, mTaskStructureActivity.doEditListtener, mTaskStructureActivity.getString(R.string.button_word_finish));
        }
