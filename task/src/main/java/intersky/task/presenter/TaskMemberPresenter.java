...
public class TaskMemberPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ImageView back = mTaskMemberActivity.findViewById(R.id.back);
        back.setOnClickListener(mTaskMemberActivity.mBackListener);
        ...
        TextView title = mTaskMemberActivity.findViewById(R.id.title);
        TextView add = mTaskMemberActivity.findViewById(R.id.add);
        add.setOnClickListener(mTaskMemberActivity.addMember);
        ...
        if(mTaskMemberActivity.getIntent().hasExtra("task"))
        {
            ...
            title.setText(mTaskMemberActivity.getString(R.string.task_member_title));
        ...
        if(mTaskMemberActivity.getIntent().hasExtra("project"))
        {
            ...
            title.setText(mTaskMemberActivity.getString(R.string.project_member_title));
            if(mTaskMemberActivity.memberDetial.leavlType < 3)
            {
                add.setVisibility(View.VISIBLE);
            }
    ...
    public void doAdd()
    {
        Bus.callData(mTaskMemberActivity,"chat/selectListAddContact",new ArrayList<Contacts>(),TaskMemberActivity.ACTION_ADD_MEMBER,
                mTaskMemberActivity.getString(R.string.add_persion),false,mTaskMemberActivity.mContactAdapter.mContacts);
    }
