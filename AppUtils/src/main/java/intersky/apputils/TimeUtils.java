...
public class TimeUtils {
    ...
    public static String getDateC(Context context) {
        Calendar c = Calendar.getInstance();
        String data =String.format("%04d",c.get(Calendar.YEAR))+context.getString(R.string.year)+
                String.format("%02d",c.get(Calendar.MONTH)+1)+context.getString(R.string.month)+
                String.format("%02d",c.get(Calendar.DAY_OF_MONTH))+context.getString(R.string.day);
        return data;
    }
    ...
    public static String getMonth(Context context) {
        Calendar c = Calendar.getInstance();
        String data =String.format("%04d",c.get(Calendar.YEAR))+"-"+
    ...
    {
        Calendar c = Calendar.getInstance();
        String data = String.format("%04d.%02d", c.get(Calendar.YEAR), c.get(Calendar.MONTH) + 1);
        return data;
    }
    ...
    public static String measureDeteForm(Context context,String time) {
        if(time.length() > 10)
        {
            if(time.substring(0,10).equals(getDate()))
            {
                return context.getString(R.string.today)+time.substring(11,time.length()).substring(0,5);
            }
            else if(daysBetween(time.substring(0,10),getDate()) == -1)
            {
                return context.getString(R.string.yestday)+time.substring(11,time.length()).substring(0,5);
            }
            else{
                return time;
            }
    ...
    public static String measureDeteForm2(Context context,String date) {
        if(date.equals(getDate()))
        {
            return context.getString(R.string.today);
        }
        else if(daysBetween(date,getDate()) == -1)
        {
            return context.getString(R.string.yestday);
        }
        else if(daysBetween(date,getDate()) == 1)
    ...
    public static String getWeek(String pTime,Context context) {
    ...
    public static String getDateAndTimeC(Context context) {
        String tmp = getDateC(context) + " " + getTimeSecond();
        return tmp;
    }

    public static String getDateAndTimeC2(Context context) {
        String tmp = getDateC(context) + " " + getTime();
        return tmp;
    }
    ...
    public static String praseTaskItemdata(Context context,String time) {
        int a = daysBetween(getDate(), time);
        if (a == -1)
            return context.getString(R.string.yestday) + time.substring(11, 16);
        else if (a == 0)
            return context.getString(R.string.today)  + time.substring(11, 16);
        else if (a == 1)
            return context.getString(R.string.tomorrow)  + time.substring(11, 16);
        else if (time.substring(0, 4).equals(getDate().substring(0, 4)))
            return time.substring(5, 7) + context.getString(R.string.month) + time.substring(8, 10) + context.getString(R.string.day);
        else
    ...
    public static String praseHistoryDate(Context context,String time) {
        ...
        if (a == -1)
            ...
            return context.getString(R.string.long_before);
    }
...
//        cal2.setFirstDayOfWeek(Calendar.MONDAY);
    ...
    public static int praseTimeToSecond(String time) {
    ...
    public static String measureDataMc(String time,Context context) {
        String y = time.substring(0,4);
        String m = time.substring(5,7);
        String d = time .substring(8,10);
        return m+context.getString(R.string.month)+d+context.getString(R.string.day);
    }
}
