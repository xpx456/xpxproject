...
//      slon = originLatLng.longitude;
    ...
    public static PopupWindow showMap(Activity context, RelativeLayout shage, View view, String address, String appname) {
    ...
    public static PopupWindow showMapLocation(Activity context, RelativeLayout shage,View view,String appname,String saddress,double slan,double slon, String address,double lan,double lon) {
        ArrayList<MenuItem> menuItems = new ArrayList<MenuItem>();
        List<String> maps = hasMap(context);
        PopupWindow popupWindow = null;
        for(int i = 0 ; i < maps.size() ; i++)
