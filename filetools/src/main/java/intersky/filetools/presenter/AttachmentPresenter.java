...
public class AttachmentPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ImageView back = mAttachmentActivity.findViewById(R.id.back);
        back.setOnClickListener(mAttachmentActivity.mBackListener);
        TextView more = mAttachmentActivity.findViewById(R.id.more);
        more.setOnClickListener(mAttachmentActivity.showMoreListener);
    ...
    public void initData() {
        TextView title = mAttachmentActivity.findViewById(R.id.title);
        title.setText(mAttachmentActivity.attachment.mName);
