...
public class PhotoSelectPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ImageView back = mPhotoSelectActivity.findViewById(R.id.back);
        back.setOnClickListener(mPhotoSelectActivity.malbumListener);
        TextView album = mPhotoSelectActivity.findViewById(R.id.album);
        album.setOnClickListener(mPhotoSelectActivity.malbumListener);
        TextView save = mPhotoSelectActivity.findViewById(R.id.save);
        save.setVisibility(View.INVISIBLE);
        mPhotoSelectActivity.title = mPhotoSelectActivity.findViewById(R.id.title);
        ...
        if(mPhotoSelectActivity.getIntent().getBooleanExtra("takephoto",false)  == true)
        {
            ...
            save.setText(mPhotoSelectActivity.getString(R.string.button_word_takephoto));
            save.setOnClickListener(mPhotoSelectActivity.mTakePhotoListener);
        }
    ...
    public void initPhoto() {
        ...
        if(AlbumItem.getInstance().contentList.size() > 0)
        {
            mPhotoSelectActivity.BucketPath = getBucketPath(
                    AlbumItem.getInstance().contentList.get(mPhotoSelectActivity.selectid).path);
        }
        ...
        if(AlbumItem.getInstance().contentList.size() > 0)
        {
            mPhotoSelectActivity.title.setText(mPhotoSelectActivity.getString(R.string.select_now)+String.format("%d", AlbumItem.getInstance().adds.size())+mPhotoSelectActivity.getString(R.string.files));
        }
