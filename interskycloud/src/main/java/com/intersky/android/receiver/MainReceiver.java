...
public class MainReceiver extends BaseReceiver {
    ...
    public MainReceiver(Handler mHandler)
    {
        ...
        intentFilter.addAction(FunctionSelectActivity.ACTION_UPDATA_WORK_ITEMS);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        else if(intent.getAction().equals(FunctionSelectActivity.ACTION_UPDATA_WORK_ITEMS))
        {
            if(mHandler != null)
            {
                Message msg = new Message();
                msg.obj = intent;
                msg.what = MainHandler.UPDATA_WORK_VIEW;
                mHandler.sendMessage(msg);
            }
        }
