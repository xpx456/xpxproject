...
public class SplashHandler extends Handler {
    ...
    public final static int EVENT_START_CHECK = 1030001;
    ...
    public void handleMessage(Message msg) {
        switch (msg.what) {
            case EVENT_START_LOGIN:
                ...
                break;
            case EVENT_START_CHECK:
                AppUtils.getPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE, theActivity, SplashHandler.PERMISSION_REQUEST_WRITE_EXTERNAL_STORAGE, theActivity.mSplashPresenter.mSplashHandler);
                break;
            ...
            case PERMISSION_REQUEST_READ_ACCESS_FINE_LOCATION:
                AppUtils.getPermission(Manifest.permission.READ_PHONE_STATE,theActivity, PERMISSION_REQUEST_READ_PHONE_STATE,theActivity.mSplashPresenter.mSplashHandler);
                break;
