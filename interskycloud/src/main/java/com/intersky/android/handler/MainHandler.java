    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case ConversationAsks.OAMESSAGE_READ_SUCCESS:
                ...
                break;
            case UPDATA_WORK_VIEW:
                theActivity.mMainPresenter.upDateWorkView();
                break;
            case RESTART:
//                if(InterskyApplication.mApp.getDarkType())
//                {
//                    theActivity.getWindow().getDecorView().setLayerType(View.LAYER_TYPE_SOFTWARE,null);
//                }
//                else
//                {
//                    theActivity.getWindow().getDecorView().setLayerType(View.LAYER_TYPE_HARDWARE,null);
//                }
                break;
            case RESTARTFINISH:
                break;
