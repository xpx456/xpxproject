    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case LoginAsks.LOGIN_SUCCESS:
                ...
                if ( LoginPrase.praseLogin(theActivity,(NetObject) msg.obj,theActivity.mLoginPresenter.mLoginHandler,InterskyApplication.mApp.mAccount))
                {

                }
                else
                {
                    theActivity.firstLayer.setVisibility(View.INVISIBLE);
                }
                break;
            case START_MAIN:
            ...
            case NetUtils.NO_NET_WORK:
                ...
                {
                    AppUtils.showMessage(theActivity,theActivity.getString(R.string.register_cloud_fail));
                }
                else
