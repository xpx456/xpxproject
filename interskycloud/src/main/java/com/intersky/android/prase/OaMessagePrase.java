...
//{"message_id":569191,"user_id":"EBEBA793-29F2-4D4D-B181-043AF51FF786","company_id":"10C1EFA4-C4AE-53C9-6F76-3B4A85C50E1A","source_type":"iCloud[reminder]","module":"iCloud","module_id":"FF3B147A-5C50-4D52-972B-D2649B226F44","source_id":"BEE3556C-60DC-4740-A585-6957C6F4F091","title":"zzzzzzz","content":"zzzzzzz","extend":"客户资料","is_read":1,"is_show":1,"create_time":"2020-08-31 14:21:28"}
    public static void praseConversation(String json) {
        try {
            ...
            if(jo.getString("source_id").equals("0") || jo.getString("source_id").length() == 0 || jo.getString("source_type").equals("iCloud[reminder]"))
            {
            ...
            if(jo.has("extend"))
            info.mTitle2 = jo.getString("extend");
    ...
    public static String getMessageType(String type) {
        ...
        else if(type.endsWith("iCloud[reminder]")) {
            return IntersakyData.CONVERSATION_TYPE_IWEB_REMIND;
        }
