...
import intersky.conversation.presenter.BasePresenter;
...
public class BaseActivity extends intersky.appbase.BaseActivity implements GestureDetector.OnGestureListener, View.OnTouchListener {
    ...
    protected void onStart() {
        ...
        if(this.findViewById(intersky.conversation.R.id.buttomaciton) != null)
            this.mToolBarHelper.hidToolbar(this, (RelativeLayout) this.findViewById(R.id.buttomaciton));
        if(this.findViewById(intersky.conversation.R.id.stutebar) != null)
