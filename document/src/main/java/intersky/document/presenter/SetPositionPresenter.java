...
public class SetPositionPresenter implements Presenter {
	...
	public void initView() {
		...
		ToolBarHelper.setTitle(mSetPositionActivity.mActionBar, mSetPositionActivity.getString(R.string.document_uploadposition));
        ToolBarHelper.setBackListenr(mSetPositionActivity.mActionBar, mSetPositionActivity.mBackListener);
        ToolBarHelper.setRightBtnText(mSetPositionActivity.mActionBar, mSetPositionActivity.mHeadRightListener, mSetPositionActivity.getString(R.string.document_newdocument));
		...
		mSetPositionActivity.mBtnLeft = (TextButton) mSetPositionActivity.findViewById(R.id.btnleft);
		mSetPositionActivity.mBtnRight = (TextButton) mSetPositionActivity.findViewById(R.id.btnright);
		...
		mSetPositionActivity.mBtnLeft.setOnClickListener(mSetPositionActivity.mButtomLeft);
		...
		mSetPositionActivity.mSampleDocumentAdapter = new DocumentAdapter(mSetPositionActivity,
