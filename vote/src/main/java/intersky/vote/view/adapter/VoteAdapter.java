...
public class VoteAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			...
			holder.mContent = (TextView) convertView.findViewById(R.id.vote_content);
		...
		holder.mName.setText(mVoteItem.userName);
		holder.mContent.setText(StringUtils.htmlToString(mVoteItem.mContent));
