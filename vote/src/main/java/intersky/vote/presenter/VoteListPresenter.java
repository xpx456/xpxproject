...
public class VoteListPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ToolBarHelper.setTitle(mVoteListActivity.mActionBar, mVoteListActivity.getString(R.string.xml_vote));
        ToolBarHelper.setRightBtn(mVoteListActivity.mActionBar, mVoteListActivity.mCreatListener,
                R.drawable.headcreat);
