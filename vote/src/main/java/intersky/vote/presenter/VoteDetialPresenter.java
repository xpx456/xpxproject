...
public class VoteDetialPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ToolBarHelper.setTitle(mVoteDetialActivity.mActionBar, mVoteDetialActivity.getString(R.string.xml_vote_center));
        mVoteDetialActivity.mTypeLayer = (RelativeLayout) mVoteDetialActivity.findViewById(R.id.typelayer);
        ...
        mVoteDetialActivity.mName = (TextView) mVoteDetialActivity.findViewById(R.id.vote_title);
        ...
        mVoteDetialActivity.mContent = (WebEdit) mVoteDetialActivity.findViewById(R.id.vote_content);
        mVoteDetialActivity.mContent.setEditable(false);
    ...
    public void Destroy() {
        ...
        mVoteDetialActivity.mContent.destroy();
    }
    ...
    public void praseDetial() {
        try {
            ...
            mVoteDetialActivity.mName.setText(mVoteDetialActivity.vote.userName);
            ...
            {
                mVoteDetialActivity.mNameType.setText(mVoteDetialActivity.getString(R.string.xml_vote_name_type_yes)
                + String.valueOf(mVoteDetialActivity.vote.personCount)+"人");
            }
            else
            {
                mVoteDetialActivity.mNameType.setText(mVoteDetialActivity.getString(R.string.xml_vote_name_type_no)
                        + String.valueOf(mVoteDetialActivity.vote.personCount)+"人");
            }

            if (mVoteDetialActivity.vote.is_close == 1) {
                mVoteDetialActivity.mTypeLayer.setBackgroundColor(Color.rgb(140, 140, 140));
            } else {
                mVoteDetialActivity.mTypeLayer.setBackgroundResource(R.drawable.tp_tips_zt);
            }
            ...
            if(mVoteDetialActivity.vote.is_close == 1  )
            {
                ...
                ToolBarHelper.setRightBtnText(mVoteDetialActivity.mActionBar, mVoteDetialActivity.mMoreListenter, " · · ·", true);
            }
            else if(VoteManager.getInstance().oaUtils.mAccount.mRecordId.equals(mVoteDetialActivity.vote.userid))
            {
                ...
                ToolBarHelper.hidRight(mVoteDetialActivity.mActionBar);
            ...
            if (mVoteDetialActivity.vote.is_close == 0) {
                ...
                mVoteDetialActivity.mTypeText.setText(mVoteDetialActivity.getString(R.string.xml_vote_closed) + ","
                        + mVoteDetialActivity.getString(R.string.xml_vote_total) + String.valueOf(mVoteDetialActivity.vote.totalCount)
                        + mVoteDetialActivity.getString(R.string.xml_vote_tic));
            }
    ...
    public void mdoVote() {
        ...
        if(has == false)
        {
            AppUtils.showMessage(mVoteDetialActivity,"投票项不能为空");
            return;
        }
        String ids = "";
        for (int i = 0; i < mVoteDetialActivity.mSelectItemModels.size(); i++) {
