...
public class MailLable3Adapter extends RecyclerView.Adapter
{
	private ArrayList<Select> mLables;
	private Context mContext;
	private LayoutInflater mInflater;
	public MailLable3Adapter(ArrayList<Select> mLables, Context context)
	{
	...
	public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		View convertView = mInflater.inflate(R.layout.mail_lable_item3, null);
