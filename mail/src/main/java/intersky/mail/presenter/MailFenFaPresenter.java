...
public class MailFenFaPresenter implements Presenter {
	...
	public void initView() {
		...
		ToolBarHelper.setTitle(mMailFengFaActivity.mActionBar, mMailFengFaActivity.getString(R.string.keyword_mailfengfa));
		ToolBarHelper.setBackListenr(mMailFengFaActivity.mActionBar, mMailFengFaActivity.mBackListener);
		...
		{
			mMailFengFaActivity.waitDialog.setTitle("正在加载用户标签信息");
			MailAsks.getUserLable(mMailFengFaHandler,mMailFengFaActivity);
