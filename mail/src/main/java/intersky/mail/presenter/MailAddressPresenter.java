...
public class MailAddressPresenter implements Presenter {
	...
	public void initView() {
		...
		ImageView back = mMailAddressActivity.findViewById(R.id.back);
		back.setOnClickListener(mMailAddressActivity.mBackListener);
		TextView title = mMailAddressActivity.findViewById(R.id.title);
		title.setText(mMailAddressActivity.getIntent().getStringExtra("name"));
