...
public class ConversationAsks {
    ...
    public static final int OAMESSAGE_SUCCESS = 1060000;
    public static final int OAMESSAGE_READ_SUCCESS = 1060001;
    public static final int OAMESSAGE_ONE_SUCCESS = 1060002;
    public static final int GROP_SUCCESS = 1060003;
    public static void getOaMessages(Context mContext, int page, Handler mHandler,String userid,String companyid) {

        String urlString = OaUtils.getOaUtils().createURLStringoa(OaUtils.getOaUtils().service,NOTATION_MESSAGE_PATH);
        ...
        nameValuePairs.add(mNameValuePair);
        mNameValuePair = new NameValuePair("source_type", "oa,iweb[workflow],iweb[mail]");
        nameValuePairs.add(mNameValuePair);
