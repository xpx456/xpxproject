...
public class ContactsPrase {
    ...
    public static int praseContacts(XpxJSONObject xpxJsonObject, Contacts mContactsClass, Context context) {
        int sum = 0;
        try {
            ...
            ContactManager.mContactManager.mOrganization.mAllContactsDepartMap.put(mContacts.mRecordid,mContacts);
