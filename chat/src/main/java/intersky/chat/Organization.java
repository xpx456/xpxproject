...
public class Organization {
    ...
    public HashMap<String,Contacts> mAllContactsDepartMap = new HashMap<String,Contacts>();
    ...
    public Contacts getContact(String recordid, Context context)
    {
        if (mAllContactsMap == null)
        {
            Contacts mContacts = new Contacts();
            mContacts.setName(context.getString(R.string.unknow));
    ...
    public String getContactName(String recordid,Context context)
    {
        if(mAllContactsMap.containsKey(recordid))
        {
            return mAllContactsMap.get(recordid).getmRName();
        }
        else
        {
            Contacts mContacts = new Contacts();
