...
public class ChatPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ToolBarHelper.setTitle(mChatActivity.mActionBar, mChatActivity.getString(R.string.chat_title_1) + mChatActivity.mContacts.getmRName() + mChatActivity.getString(R.string.chat_title_2));
        ...
        ToolBarHelper.setRightBtnText(mChatActivity.mActionBar, new View.OnClickListener() {
            @Override
        ...
        }, mChatActivity.getString(R.string.button_compliant));
