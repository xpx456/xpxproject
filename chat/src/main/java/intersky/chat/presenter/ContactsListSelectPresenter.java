...
public class ContactsListSelectPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ToolBarHelper.setTitle(mContactsListSelectActivity.mActionBar,mContactsListSelectActivity.getIntent().getStringExtra("title"));
        ToolBarHelper.setBackListenr(mContactsListSelectActivity.mActionBar,mContactsListSelectActivity.dackListener);
