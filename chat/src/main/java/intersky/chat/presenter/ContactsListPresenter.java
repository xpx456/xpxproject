...
public class ContactsListPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ImageView back = mContactsListActivity.findViewById(R.id.back);
        back.setOnClickListener(mContactsListActivity.mBackListener);
        ...
        TextView title = mContactsListActivity.findViewById(R.id.title);
        title.setText(ContactManager.mContactManager.mOrganization.showContacts.getName());
        updataContactView();
    }
    ...
    private void sendIm(Contacts contacts) {
        ...
        if(mContactsListActivity.getIntent().hasExtra("path")) {
            ...
            if(mfile.exists())
            {
                ...
                {
                    msg.mSubject = mContactsListActivity.getString(R.string.pic);
                    msg.sourceType = Conversation.MESSAGE_TYPE_IMAGE;
                }
                else
                {
                    msg.sourceType = Conversation.MESSAGE_TYPE_FILE;
                    msg.mSubject = mContactsListActivity.getString(R.string.file);
                }
    ...
    public void sendLocation(Context context, Contacts contacts, String json) {
        ...
        msg.isRead = true;
        msg.isSendto = true;
        msg.mSubject = mContactsListActivity.getString(R.string.location)+":"+name;
        msg.sourceName = json;
        ...
        if (mfile.exists()) {
            ...
            AppUtils.showMessage(context, context.getString(R.string.nofile));
        }
    }
}
