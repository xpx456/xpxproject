...
public class RegisterPresenter implements Presenter {
    ...
    public void initView() {
        registerActivity.flagFillBack = false;
        ...
        btnDelete = registerActivity.findViewById(R.id.btn_delete);
        ...
        if(ExhibitionApplication.mApp.getLic())
        {
            licence.setInputType(InputType.TYPE_TEXT_VARIATION_PASSWORD|InputType.TYPE_CLASS_TEXT);
        }
        ...
        btnSubmit.setOnClickListener(deleteListener);
    ...
    public View.OnClickListener deleteListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if(guest.rid.length() > 0)
            {
                DBHelper.getInstance(registerActivity).deleteGuestFinger(guest);
                DBHelper.getInstance(registerActivity).deleteGuest(guest);
                setHidinput();
                registerActivity.finish();
            }
