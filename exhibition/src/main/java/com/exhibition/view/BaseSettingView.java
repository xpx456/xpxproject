...
public class BaseSettingView extends PopView {
    ...
    public void initView() {
        ...
        updatabtn = mainView.findViewById(R.id.updatachange);
        ...
        updatabtn.setOnClickListener(changeUpdataListener);
    ...
    private View.OnClickListener changeUpdataListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            ExhibitionApplication.mApp.initVideoAndPhoto();
        }
    };
