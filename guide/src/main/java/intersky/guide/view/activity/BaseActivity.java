...
import intersky.guide.presenter.BasePresenter;
...
public class BaseActivity extends intersky.appbase.BaseActivity implements GestureDetector.OnGestureListener, View.OnTouchListener {
    ...
    protected void onStart() {
        if(this.findViewById(R.id.buttomaciton) != null)
            shownave = this.mToolBarHelper.hidToolbar(this, (RelativeLayout) this.findViewById(R.id.buttomaciton));
