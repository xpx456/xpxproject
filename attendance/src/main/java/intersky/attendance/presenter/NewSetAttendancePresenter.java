...
public class NewSetAttendancePresenter implements Presenter {
	...
	public void initView() {
		...
		ToolBarHelper.setTitle(mNewSetAttendanceActivity.mActionBar,mNewSetAttendanceActivity.getString(R.string.xml_attdance_new_title));
		ToolBarHelper.setRightBtnText(mNewSetAttendanceActivity.mActionBar,mNewSetAttendanceActivity.saveListener,mNewSetAttendanceActivity.getString(R.string.button_word_save));
	...
	public void selectCopyer() {
		AttendanceManager.getInstance().oaUtils.mContactManager.selectListContact(mNewSetAttendanceActivity
				,mNewSetAttendanceActivity.mCopyers,NewSetAttendanceActivity.ACTION_SET_ATTENDANCE_CONTACTS,"选择联系人",false);
	}
