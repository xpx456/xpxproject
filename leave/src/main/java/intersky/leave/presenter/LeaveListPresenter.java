...
public class LeaveListPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ToolBarHelper.setTitle(mLeaveListActivity.mActionBar, mLeaveListActivity.getString(R.string.xml_leave_title_approve));
        ToolBarHelper.setRightBtn(mLeaveListActivity.mActionBar, mLeaveListActivity.creatListener, mLeaveListActivity.mShowMore, R.drawable.headcreat, " · · ·");
        ...
        mLeaveListActivity.mLine1 = (RelativeLayout) mLeaveListActivity.findViewById(R.id.line13);
        mLeaveListActivity.mLine2 = (RelativeLayout) mLeaveListActivity.findViewById(R.id.line23);
        mLeaveListActivity.mLine3 = (RelativeLayout) mLeaveListActivity.findViewById(R.id.line33);
        mLeaveListActivity.mLine11 = (RelativeLayout) mLeaveListActivity.findViewById(R.id.line12);
        mLeaveListActivity.mLine21 = (RelativeLayout) mLeaveListActivity.findViewById(R.id.line22);
        mLeaveListActivity.mLine31 = (RelativeLayout) mLeaveListActivity.findViewById(R.id.line32);
    ...
    public void showLeft() {
        ...
        mLeaveListActivity.mLine1.setBackgroundColor(Color.rgb(98, 153, 243));
        mLeaveListActivity.mLine2.setBackgroundColor(Color.rgb(242, 242, 242));
        mLeaveListActivity.mLine3.setBackgroundColor(Color.rgb(242, 242, 242));
        mLeaveListActivity.mLine1.setVisibility(View.VISIBLE);
        mLeaveListActivity.mLine2.setVisibility(View.INVISIBLE);
        mLeaveListActivity.mLine3.setVisibility(View.INVISIBLE);
        mLeaveListActivity.mRightImg.setTextColor(Color.rgb(0, 0, 0));
        mLeaveListActivity.mMiddleImg.setTextColor(Color.rgb(0, 0, 0));
        mLeaveListActivity.mLefttImg.setTextColor(Color.rgb(98, 153, 243));
    ...
    public void showMiddle() {
        ...
        mLeaveListActivity.mLine1.setBackgroundColor(Color.rgb(242, 242, 242));
        mLeaveListActivity.mLine2.setBackgroundColor(Color.rgb(98, 153, 243));
        mLeaveListActivity.mLine3.setBackgroundColor(Color.rgb(242, 242, 242));
        mLeaveListActivity.mLine1.setVisibility(View.INVISIBLE);
        mLeaveListActivity.mLine2.setVisibility(View.VISIBLE);
        mLeaveListActivity.mLine3.setVisibility(View.INVISIBLE);
        mLeaveListActivity.mRightImg.setTextColor(Color.rgb(0, 0, 0));
        mLeaveListActivity.mMiddleImg.setTextColor(Color.rgb(98, 153, 243));
        mLeaveListActivity.mLefttImg.setTextColor(Color.rgb(0, 0, 0));
    ...
    public void showRight() {
        ...
        mLeaveListActivity.mLine1.setBackgroundColor(Color.rgb(242, 242, 242));
        mLeaveListActivity.mLine2.setBackgroundColor(Color.rgb(242, 242, 242));
        mLeaveListActivity.mLine3.setBackgroundColor(Color.rgb(98, 153, 243));
        mLeaveListActivity.mLine1.setVisibility(View.INVISIBLE);
        mLeaveListActivity.mLine2.setVisibility(View.INVISIBLE);
        mLeaveListActivity.mLine3.setVisibility(View.VISIBLE);
        mLeaveListActivity.mRightImg.setTextColor(Color.rgb(98, 153, 243));
        mLeaveListActivity.mMiddleImg.setTextColor(Color.rgb(0, 0, 0));
        mLeaveListActivity.mLefttImg.setTextColor(Color.rgb(0, 0, 0));
    ...
    public void initData() {
        mLeaveListActivity.myLeaveAdapter = new LeaveAdapter(mLeaveListActivity.mMyLeaves, mLeaveListActivity,0);
        mLeaveListActivity.approveLeaveAdapter = new LeaveAdapter(mLeaveListActivity.mApproveLeaves, mLeaveListActivity,1);
        mLeaveListActivity.copyLeaveAdapter = new LeaveAdapter(mLeaveListActivity.mCopyLeaves, mLeaveListActivity,2);
        mLeaveListActivity.mysLeaveAdapter = new LeaveAdapter(mLeaveListActivity.mMysLeaves, mLeaveListActivity,0);
        mLeaveListActivity.approvesLeaveAdapter = new LeaveAdapter(mLeaveListActivity.mApprovesLeaves, mLeaveListActivity,1);
        mLeaveListActivity.copysLeaveAdapter = new LeaveAdapter(mLeaveListActivity.mCopysLeaves, mLeaveListActivity,2);
        mLeaveListActivity.mMyList.setAdapter(mLeaveListActivity.myLeaveAdapter);
        mLeaveListActivity.mApproveList.setAdapter(mLeaveListActivity.approveLeaveAdapter);
        mLeaveListActivity.mCopyList.setAdapter(mLeaveListActivity.copyLeaveAdapter);
        showLeft();
...
//		mNoticeActivity.mLoderPageAdapter.notifyDataSetChanged();
    ...
    public void setuser(Intent intent) {
        ...
        ToolBarHelper.setTitle(mLeaveListActivity.mActionBar, LeaveManager.getInstance().setContacts.mName + mLeaveListActivity.getString(R.string.xml_leave_title_approve_ex));
        updataAll();
    }
