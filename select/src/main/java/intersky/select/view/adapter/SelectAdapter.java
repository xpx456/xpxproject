...
public class SelectAdapter extends BaseAdapter
{
	...
	public int color1 = Color.parseColor("#23272E");
	public int color2 = Color.parseColor("#1EA1F3");
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if(mSelectMoreModel.mType == 0)
		{
			...
			if(mSelectMoreModel.iselect == true)
			{
				...
				mview.micon.setImageResource(R.drawable.selectmial);
			}
			else
			{
				mview.mMail.setTextColor(color1);
				mview.micon.setImageResource(R.drawable.image_null);
			}
		}
		else
		{
