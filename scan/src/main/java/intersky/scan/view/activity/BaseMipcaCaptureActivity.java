...
import intersky.scan.presenter.MipcaCapturePresenter;
 ...
 * @author Ryan.Tang
 */
public class BaseMipcaCaptureActivity extends BaseActivity implements Callback {
	...
	public BaseMipcaCapturePresenter mMipcaCapturePresenter = new BaseMipcaCapturePresenter(this);
