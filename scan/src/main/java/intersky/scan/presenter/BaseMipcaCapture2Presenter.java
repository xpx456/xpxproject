...
public class BaseMipcaCapture2Presenter implements Presenter {
	...
	public BaseMipcaCapture2Presenter(BaseMipcaCapture2Activity mMipcaCaptureActivity)
	{
...
//			surfaceHolder.setFormat(SurfaceHolder.);
	...
	public void initCamera(SurfaceHolder surfaceHolder) {
		...
		if (handler == null) {
			handler = new BaseCaptureActivity2Handler(mMipcaCaptureActivity, mMipcaCaptureActivity.decodeFormats,
