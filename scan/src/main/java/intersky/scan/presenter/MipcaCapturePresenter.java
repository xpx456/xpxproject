...
public class MipcaCapturePresenter implements Presenter {
	...
	public MipcaCapturePresenter(MipcaCaptureActivity mMipcaCaptureActivity)
	{
	...
	public void initView() {
		...
		ImageView back = mMipcaCaptureActivity.findViewById(R.id.back);
		back.setOnClickListener(mMipcaCaptureActivity.mBackListener);
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			else
			{
				...
				resultIntent.setAction(mMipcaCaptureActivity.getIntent().getAction());
				Bundle bundle = new Bundle();
				bundle.putString("result", resultString);
				resultIntent.putExtras(bundle);
				mMipcaCaptureActivity.sendBroadcast(resultIntent);
...
//		}
	...
	public void initCamera(SurfaceHolder surfaceHolder) {
		...
		if (handler == null) {
			handler = new CaptureActivityHandler(mMipcaCaptureActivity, mMipcaCaptureActivity.decodeFormats,
