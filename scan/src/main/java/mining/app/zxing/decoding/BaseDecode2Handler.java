...
final class BaseDecode2Handler extends Handler {

  private static final String TAG = BaseDecode2Handler.class.getSimpleName();

  private final BaseMipcaCapture2Activity activity;
  private final MultiFormatReader multiFormatReader;

  BaseDecode2Handler(BaseMipcaCapture2Activity activity, Hashtable<DecodeHintType, Object> hints) {
