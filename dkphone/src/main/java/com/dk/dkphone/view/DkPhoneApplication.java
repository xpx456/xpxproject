...
public class DkPhoneApplication extends Application {
    ...
    public static final String CHECK_VERSION_URL = "http://www.intersky.com.cn/app/android.version/dkphone.txt";
    public static final String UPDATA_APP_URL = "http://www.intersky.com.cn/app/android.version/dkphone.apk";

    public int maxSelect = 1;
    public String versionName = "";
    public int versionCode = 1;
    public static final String UPDATE_NAME = "dkphone.apk";
    public static final String VIDEO_NAME = "test.mp4";
    public AppActivityManager appActivityManager;
    public static DkPhoneApplication mApp;
    public boolean LOGO_MODE = false;
    ...
    public void onCreate() {
        ...
        CrashReport.initCrashReport(getApplicationContext(), "28d32af146", false);
        ScanUtils.init(mApp);
        fileUtils = FileUtils.init(mApp,getProvidePath,null,null);
        fileUtils.pathUtils.setAppBase("/dkphone");
...
//        initBgs();
    ...
    public void initOtherModule() {
        try {
            ...
            DkPhoneApplication.mApp.mUpDataManager = UpDataManager.init(DkPhoneApplication.mApp, DkPhoneApplication.CHECK_VERSION_URL, DkPhoneApplication.UPDATA_APP_URL,
                    packInfo.versionName,packInfo.versionCode,file.getPath()+"/"+ DkPhoneApplication.UPDATE_NAME, DkPhoneApplication.mApp.updataOperation, DkPhoneApplication.mApp.getProvidePath);
    ...
    public static GetProvideGetPath getProvidePath = new GetProvideGetPath() {
        ...
        public Uri getProvideGetPath(File file) {
            return FileProvider.getUriForFile(DkPhoneApplication.mApp, "com.dk.dkphone.fileprovider", file);
        }
    };
    ...
    private void initUsers() {
        ...
        sportData = DBHelper.getInstance(mApp).scanRecords(selectUser.uid);
...
//        }
        DkPhoneApplication.mApp.testManager.setNewTest(selectUser);
    }
    ...
    public void initSpeedValue()
    {
        DkPhoneApplication.mApp.testManager.xpxUsbManager.SPEED_MODE =
                DkPhoneApplication.mApp.sharedPre.getInt(UserDefine.SPEED_MODE,0);
    }

    public void initLogoValue()
    {
        DkPhoneApplication.mApp.LOGO_MODE =
                DkPhoneApplication.mApp.sharedPre.getBoolean(UserDefine.LOGO_MOOD,false);
    }
