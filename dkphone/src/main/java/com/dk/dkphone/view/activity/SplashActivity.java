...
import com.dk.dkphone.presenter.SplashPresenter;
			...
			case SplashHandler.PERMISSION_REQUEST_WRITE_EXTERNAL_STORAGE:
				if(grantResults.length > 0)
				{
					if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
						AppUtils.getPermission(Manifest.permission.READ_EXTERNAL_STORAGE,this, SplashHandler.EVENT_START_LOGIN,this.mSplashPresenter.mSplashHandler);
					} else {
						finish();
					}
				}
