...
import com.dk.dkphone.view.adapter.OptationAdapter;
...
//        mMainActivity.btnlanya.setOnClickListener(deviceListener);
        ...
        if(TestManager.testManager.blueconnect == true)
        {
    ...
    {
        if(TestManager.testManager.blueconnect == false)
        {
    ...
    public SeekBar.OnSeekBarChangeListener onSeekBarChangeListener = new SeekBar.OnSeekBarChangeListener()
    {
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            DkPadApplication.mApp.testManager.setLeavestete(seekBar.getProgress());
    ...
    public void scanFinish(Intent intent) {
        ...
        try {
            ...
            DkPadApplication.mApp.testManager.bluetoothSetManager.
                    autoFindConnectDevice(mMainActivity,mMainActivity.findViewById(R.id.activity_main),address);
    ...
    public AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener(){
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if(DkPadApplication.mApp.testManager.bluetoothSetManager.bluetoothDevice == null)
            {
                DkPadApplication.mApp.testManager.bluetoothSetManager.autoConnectDevice(mMainActivity,mMainActivity.findViewById(R.id.activity_main),bluetoothDevice);
            }
            else
            {
                if(bluetoothDevice.getAddress().equals(DkPadApplication.mApp.testManager.bluetoothSetManager.bluetoothDevice.getAddress())
                        && bluetoothDevice.getBondState() == BluetoothDevice.BOND_BONDED && DkPadApplication.mApp.testManager.bluetoothSetManager.mConnectionState == BluetoothSetManager.STATE_CONNECTED)
                {
                    DkPadApplication.mApp.testManager.bluetoothSetManager.disconnect();
                }
                else
                {
                    DkPadApplication.mApp.testManager.bluetoothSetManager.autoConnectDevice(mMainActivity,mMainActivity.findViewById(R.id.activity_main),bluetoothDevice);
    ...
    public View.OnClickListener startListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            {
                if(DkPadApplication.mApp.testManager.bluetoothSetManager.mBluetoothGatt != null) {

                    if (DkPadApplication.mApp.testManager.bluetoothSetManager.mConnectionState == BluetoothSetManager.STATE_CONNECTED){
    ...
    public void updataTime() {
        mMainActivity.time.setText(TimeUtils.getDateAndTimeC());
