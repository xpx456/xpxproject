...
import com.dk.dkphone.view.activity.PadFragmentBaseActivity;
...
public class PadFragmentBasePresenter implements Presenter{

	private PadFragmentBaseActivity mBaseActivity;
	public ScreenDefine mScreenDefine;

	public PadFragmentBasePresenter(PadFragmentBaseActivity mBaseActivity)
	{
