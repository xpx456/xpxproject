...
public class OptationPresenter implements Presenter {
    ...
    public void uptataTotalTime() {
        int totalsecond = DkPhoneApplication.OPTATION_ITEM_PER_SECOND *optationItems.size();
    ...
    public void addView(OptationItem optationItem,int postation)
    {
        ...
        int second = DkPhoneApplication.OPTATION_ITEM_PER_SECOND *(postation+1)%60;
        int min = DkPhoneApplication.OPTATION_ITEM_PER_SECOND *(postation+1)/60%60;
    ...
    public View.OnClickListener deleteOptationListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            if(DkPhoneApplication.mApp.hashMap.size() == 1)
            {
