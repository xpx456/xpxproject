...
public class NoticeDetialPresenter implements Presenter {
    ...
    public void initView() {
        ...
        ImageView back = mNoticeDetialActivity.findViewById(R.id.back);
        back.setOnClickListener(mNoticeDetialActivity.mBackListener);
        TextView head = mNoticeDetialActivity.findViewById(R.id.contact_img);
        AppUtils.setContactCycleHead(head,mNoticeDetialActivity.notice.username);
        ...
        mNoticeDetialActivity.btnSend = mNoticeDetialActivity.findViewById(R.id.btn_send);
        mNoticeDetialActivity.btnSend.setOnClickListener(mNoticeDetialActivity.sendListener);
    ...
    public void praseAttahcmentViews() {
        for(int i = 0 ; i < mNoticeDetialActivity.mPics.size() ; i++)
        {
            ...
            Bus.callData(mNoticeDetialActivity,"filetools/addPicView",attachment,url,mNoticeDetialActivity.mAttachmentlayer);
        }
    }
